        ...
        <div class="content-body">
            ...
            <section class="vertical-wizard">
                ...
                <div class="bs-stepper-content">
                    <form id="destinasi-store" action="{{route('destinasi.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div
                        ...
                        <div class="row">
                            ...
                            <div class="mb-1">
                                ...
                                <textarea name="alamat" class="form-control" cols="30" rows="6">{{old('alamat')}}</textarea>
                            </div>
                            <div class="mb-1">
                                ...
                                @foreach ($kategori as $k)
                                    <option @if ($k->id == old('kategori')) selected @endif value="{{$k->id}}">{{$k->kategori}}</option>
                                @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            <div class="mb-1">
                                ...
                                <input type="text" class="form-control" name="longlat" id="longlat" placeholder="-5.1676734, 119.4782512" value="{{old('longlat')}}">
